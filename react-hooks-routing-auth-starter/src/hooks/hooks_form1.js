/**
 * form that has all three ways to update 
 * state with useState, useReducer and useContext.
 * show how to save the state from a form using
 * the useReducer, useState and useContext hooks
 */
